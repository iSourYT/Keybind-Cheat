...
{
public:
	IMaterial2* FindMaterial(char const* pMaterialName, const char *pTextureGroupName, bool complain = true, const char *pComplainPrefix = NULL)
	{
		typedef IMaterial2*(__thiscall* oFindMaterial)(PVOID, char const*, char const*, bool, char const*);
		return call_vfunc< oFindMaterial >(this, Offsets::VMT::MaterialSystem_FindMaterial)(this, pMaterialName, pTextureGroupName, complain, pComplainPrefix);
	}

	IMaterial2*	CreateMaterial(const char *pMaterialName, KeyValues *pVMTKeyValues)
	{
		typedef IMaterial2* (__thiscall* oCreateMaterial)(PVOID, const char *, KeyValues*);
		return call_vfunc<oCreateMaterial>(this, Offsets::VMT::MaterialSystem_CreateMaterial)(this, pMaterialName, pVMTKeyValues);
	}
	MaterialHandle_t FirstMaterial()
	{
	...
	IMaterial2* GetMaterial(MaterialHandle_t h)
	{
		typedef IMaterial2*(__thiscall* GetMaterialFn)(void*, MaterialHandle_t);
		return call_vfunc<GetMaterialFn>(this, 89)(this, h);
	}
};
...
public:
	...
	void ForcedMaterialOverride2(IMaterial2 *material, OverrideType_t type = OVERRIDE_NORMAL, int idk = NULL)
	{
		typedef void(__thiscall* Fn)(void*, IMaterial2*, OverrideType_t, int);
		return call_vfunc<Fn>(this, Offsets::VMT::ModelRender_ForcedMaterialOverride)(this, material, type, idk);
	}

	void ForcedMaterialOverride3(IMaterial2* m, OverrideType_t o, int i)
	{
		typedef void(__thiscall* tForcedMaterialOverride)(PVOID, IMaterial2*, OverrideType_t, int);
		call_vfunc<tForcedMaterialOverride>(this, 1)(this, m, o, i);
	}
};
...
public:
	...
	inline const char* GetModelName2(const void* Model) {
