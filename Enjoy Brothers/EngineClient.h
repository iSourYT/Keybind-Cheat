...
public:
	...
	virtual float		GetAvgLoss(int flow) const = 0;	 // avg packet [0..1]
...
public:
	...
	//void GetScreenSize2(int& iWidth, int& iHeight)
	//{
	//	VirtualFn(void)(PVOID, int&, int&);
	//	call_vfunc< OriginalFn >(this, 5)(this, iWidth, iHeight);
	//}
	//void GetScreenSize2(int* piScreenSize)
	//{
	//	GetScreenSize2(piScreenSize[0], piScreenSize[1]);
	//}
	...
	//void GetViewAngles2(QAngle& qViewAngles)
	//{
	//	VirtualFn(void)(PVOID, QAngle&);
	//	call_vfunc< OriginalFn >(this, 18)(this, qViewAngles);
//	}
